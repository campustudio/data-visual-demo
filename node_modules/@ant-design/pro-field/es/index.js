...
var defaultRenderText = function defaultRenderText(text, valueType, props, valueTypeMap) {
  ...
  if (valueType === 'checkbox') {
    return /*#__PURE__*/React.createElement(FiledCheckbox, _extends({
      text: text
    }, props));
  }
  ...
  if (valueType === 'rate') {
    return /*#__PURE__*/React.createElement(FiledRate, _extends({
      text: text
    }, props));
  }

  if (valueType === 'switch') {
    return /*#__PURE__*/React.createElement(FiledSwitch, _extends({
      text: text
    }, props));
  }
