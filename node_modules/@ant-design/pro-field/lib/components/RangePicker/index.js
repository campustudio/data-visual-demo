...
var FieldRangePicker = function FieldRangePicker(_ref, ref) {
  ...
  var _useState = (0, _react.useState)(false),
      ...
      open = _useState2[0],
      setOpen = _useState2[1]; // activePickerIndex for https://github.com/ant-design/ant-design/issues/22158


  var _useState3 = (0, _react.useState)(),
      _useState4 = _slicedToArray(_useState3, 2),
      activePickerIndex = _useState4[0],
      setActivePickerIndex = _useState4[1];
  ...
  if (mode === 'edit' || mode === 'update') {
    ...
    if (light) {
      ...
      }, /*#__PURE__*/_react.default.createElement(_datePicker.default.RangePicker, _extends({}, fieldProps, {
        ref: ref,
        format: format,
        showTime: showTime,
      ...
      _dom = /*#__PURE__*/_react.default.createElement(_datePicker.default.RangePicker, _extends({
        ref: ref,
        format: format,
        showTime: showTime,
        placeholder: [intl.getMessage('tableForm.selectPlaceholder', '请选择'), intl.getMessage('tableForm.selectPlaceholder', '请选择')],
