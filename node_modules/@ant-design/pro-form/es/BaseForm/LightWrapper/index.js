...
import { FilterDropdown, FieldLabel, isDropdownValueType, useMountMergeState } from '@ant-design/pro-utils';
import './index.less';
  ...
  if (!light || customLightMode || isDropdown) {
    if ( /*#__PURE__*/React.isValidElement(children)) {
      ...
      return /*#__PURE__*/React.cloneElement(children, _objectSpread(_objectSpread({
        ...
        fieldProps: _objectSpread((_objectSpread2 = {
          id: id
        }, _defineProperty(_objectSpread2, valuePropName, props[valuePropName]), _defineProperty(_objectSpread2, "onChange", onChange), _defineProperty(_objectSpread2, "onBlur", onBlur), _objectSpread2), children.props.fieldProps)
      }));
    }
