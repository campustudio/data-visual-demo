...
function defaultRenderText(config) {
  ...
  if (config.mode !== 'edit') {
    return /*#__PURE__*/_react.default.createElement(_proField.default, _extends({
      fieldProps: (0, _proUtils.getFieldPropsOrFormItemProps)(columnProps === null || columnProps === void 0 ? void 0 : columnProps.fieldProps, undefined, columnProps)
    }, proFieldProps));
  ...
  return /*#__PURE__*/_react.default.createElement(_form.default.Item, {
    ...
    }, formItemProps), /*#__PURE__*/_react.default.createElement(_proField.default, _extends({
