...
var useFetchData = function useFetchData(getData, defaultData, options) {
  ...
  var _useState = (0, _react.useState)(false),
      ...
      pollingLoading = _useState2[0],
      setPollingLoading = _useState2[1]; // Batching update  https://github.com/facebook/react/issues/14259
  ...
  var fetchList = /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(isPolling) {
      var pageSize, current, pageParams, _yield$getData, _yield$getData$data, data, success, _yield$getData$total, total, rest, responseData;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 12:
              ...
              _yield$getData$data = _yield$getData.data;
              data = _yield$getData$data === void 0 ? [] : _yield$getData$data;
              success = _yield$getData.success;
              _yield$getData$total = _yield$getData.total;
              total = _yield$getData$total === void 0 ? 0 : _yield$getData$total;
              rest = _objectWithoutProperties(_yield$getData, ["data", "success", "total"]);
  ...
  var fetchListDebounce = (0, _proUtils.useDebounceFn)( /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(isPolling) {
      var needPolling, msg;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              needPolling = (0, _proUtils.runFunction)(polling, list);
              _context2.next = 4;
              return fetchList(isPolling !== null && isPolling !== void 0 ? isPolling : needPolling);
  ...
  }(), [manualRequestRef.current], debounceTime);
  /** PageIndex 改变的时候自动刷新 */
  ...
  return {
    ...
    reset: function reset() {
      var _ref6 = options || {},
          optionPageInfo = _ref6.pageInfo;

      var _ref7 = optionPageInfo || {},
          _ref7$defaultCurrent = _ref7.defaultCurrent,
          defaultCurrent = _ref7$defaultCurrent === void 0 ? 1 : _ref7$defaultCurrent,
          _ref7$defaultPageSize = _ref7.defaultPageSize,
          defaultPageSize = _ref7$defaultPageSize === void 0 ? 20 : _ref7$defaultPageSize;
